  ...
  return (
    ...
    >
      ...
      >
        <motion.article
          variants={revealItem}
          className="projects-cta-card sculptor-spotlight-card"
        >
          ...
          <div className="sculptor-spotlight-card__copy">
            <div className="projects-cta-card__eyebrow-row">
              ...
              <span className="projects-cta-card__status">
                {sculptor.version}
              </span>
            </div>

            <h3 className="projects-cta-card__title">
            ...
            <div className="sculptor-spotlight-card__action-grid">
              <button
                type="button"
                className="sculptor-spotlight-card__action-card"
                onClick={onOpenSculptorGuide}
              >
                <span className="sculptor-spotlight-card__action-kicker">
                  Guide
                </span>
                <span className="sculptor-spotlight-card__action-title">
                  Read the docs map
                </span>
                <span className="sculptor-spotlight-card__action-copy">
                  Runtime flow, package docs, config model, and the live
                  markdown reader.
                </span>
                <span className="sculptor-spotlight-card__action-footer">
                  Open guide <FaArrowRightLong aria-hidden="true" />
                </span>
              </button>
              ...
              >
                ...
                <span className="sculptor-spotlight-card__action-copy">
                  Quick access to the Sculptor package family and package
                  releases.
                </span>
                <span className="sculptor-spotlight-card__action-footer">
                  Open npm <FaArrowRightLong aria-hidden="true" />
                </span>
              </a>
            </div>
            ...
            <button
              type="button"
              className="hero-action sculptor-spotlight-card__product-link"
              onClick={onOpenSculptorPage}
            >
              Open product page
            </button>
          </div>
